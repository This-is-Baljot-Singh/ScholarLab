...
// Removed fallback data for production wiring
...
export const FacultyOverview: React.FC = () => {
  ...
  const { data: activeSessions = [], isError: isSessionsError } = useQuery<ActiveSessionSummary[]>({
    queryKey: ['faculty-active-sessions-overview'],
    queryFn: async () => {
